...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    // declare the all database variable
    ...
    private static final String CREATE_TABLE_STUDENTS = "CREATE TABLE " + TABLE_USER + "(" + KEY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + KEY_FIRSTNAME + " TEXT );";

    private static final String CREATE_TABLE_USER_HOBBY = "CREATE TABLE " + TABLE_USER_HOBBY + "(" + KEY_ID + " INTEGER," + KEY_HOBBY + " TEXT );";

    private static final String CREATE_TABLE_USER_CITY = "CREATE TABLE " + TABLE_USER_CITY + "(" + KEY_ID + " INTEGER," + KEY_CITY + " TEXT );";
    ...
    public boolean deleteUser(int id) {
        SQLiteDatabase db = this.getWritableDatabase();
        String selectString = "SELECT * FROM " + TABLE_USER + " WHERE " + KEY_ID + " =?";
        ...
        Log.e(String.valueOf(deleteUser), "Deleted User");
        cursor.close();
        if (deleteUser == true) {
